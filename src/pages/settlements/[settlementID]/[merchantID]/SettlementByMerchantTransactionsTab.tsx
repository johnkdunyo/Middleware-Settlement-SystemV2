...
const SingleTableRow = ({ ind }: { ind: number }) => {
  return (
    <tr className="border-b -z-10  group hover:bg-gray-100 whitespace-nowrap cursor-pointer text-gray-600 ">
      ...
      <td className="px-4 py-2">43828132-6259-4029-b901-81007989da69</td>
      <td className="px-4 py-2">200</td>
      <td className="px-4 py-2">{ind}mtn</td>
...
const SettlementByMerchantTransactionsTab = () => {
...
export default SettlementByMerchantTransactionsTab;
